			...
			<div class="b-part">
				<div class="b-part1">
					...
					<div class="b-p3">
						<div class="bp3">
							<div class="b-part3">
	<p>Gjeni të gjitha informacionet thelbësore të çdo biznesi në Therandë. Ku ndodhen, cilat janë shërbimet e tyre dhe detajet kontaktuese gjithashtu
								</p>
							</div>
						</div>
					</div>
...
<?php
       ...
       while($row = mysqli_fetch_array($query))
        {
          ...
          $fileName = $row['Pershkrimi'];
           $description = $row['Teksti'];
             $fileName2 = $row['hrefLinku'];
         $fileUpload = $row['FotojaSrc'];
            ?>
     ...
     <div class="wrapper">
      ...
      <img src="file/<?php echo $fileUpload; ?>" class="box">
