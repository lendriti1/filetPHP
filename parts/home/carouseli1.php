...
<body>
  <main class="Main">
    <h1 style="font-size:30px;margin:20px 0px 20px 0px">Galeria</h1>
    ...
    <section class="Carousel" id="carousel" tabindex="-1">
      ...
      <article class="Card Card--overlay Card--portrait" id="card-3">
        ...
        <div class="Card__main">
          <h2 class="Card__heading">
            <a class="Card__link" href="#">Prefer 3/4 aspect ratio</a>
          </h2>
      ...
      <article class="Card Card--overlay Card--photo" id="card-4">
        ...
        <div class="Card__main">
          <h2 class="Card__heading">
            <a class="Card__link" href="#">Prefer 4/3 aspect ratio</a>
          </h2>
          <p>This is a generic card pattern.</p>
        </div>
      </article>
      ...
      <article class="Card Card--overlay Card--square" id="card-5">
        ...
        <div class="Card__main">
          <h2 class="Card__heading">
            <a class="Card__link" href="#">Prefer 1/1 aspect ratio</a>
          </h2>
          <p>This is a generic card pattern.</p>
        </div>
      </article>
      ...
      <article class="Card Card--overlay Card--wide" id="card-6">
        ...
        <div class="Card__main">
          <h2 class="Card__heading">
            <a class="Card__link" href="#">Prefer 16/9 aspect ratio</a>
          </h2>
          <p>This is a generic card pattern.</p>
        </div>
      </article>
    ...
    <nav class="Pagination">
      <h2 class="Hidden1">Carousel Navigation</h2>
      <button class="Arrow" type="button" aria-controls="carousel" disabled>
        ...
        <span class="Hidden1">Previous slide</span>
      </button>
      <button class="Arrow" type="button" aria-controls="carousel" disabled>
        <svg width="16" height="16" viewBox="0 0 16 16" role="presentation">
          <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8zm15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H4.5z" />
        </svg>
        <span class="Hidden1">Next slide</span>
      </button>
      <div class="Dots">
        <a href="#card-1" class="Dot" tabindex="-1"><span class="Hidden1">Slide 1</span></a>
        <a href="#card-2" class="Dot" tabindex="-1"><span class="Hidden1">Slide 2</span></a>
        <a href="#card-3" class="Dot" tabindex="-1"><span class="Hidden1">Slide 3</span></a>
        <a href="#card-4" class="Dot" tabindex="-1"><span class="Hidden1">Slide 4</span></a>
        <a href="#card-5" class="Dot" tabindex="-1"><span class="Hidden1">Slide 5</span></a>
        <a href="#card-6" class="Dot" tabindex="-1"><span class="Hidden1">Slide 6</span></a>
        <a href="#card-7" class="Dot" tabindex="-1"><span class="Hidden1">Slide 7</span></a>
        <a href="#card-8" class="Dot" tabindex="-1"><span class="Hidden1">Slide 8</span></a>
